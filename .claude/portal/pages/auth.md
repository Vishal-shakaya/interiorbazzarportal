...
service — see [../../Environment-Management-backend.md](../../Environment-Management-backend.md).)
...
- **No raw localStorage.** All session reads/writes go through `AuthService` (wrapping the `ib_auth`
  ...
  (see [../../Environment-Management-backend.md](../../Environment-Management-backend.md)).
