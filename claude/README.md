...
> Read [Environment & Backend Strategy](../../docs/environment-and-backend.md) first.
...
(see [Environment & Backend Strategy](../../docs/environment-and-backend.md)).
...
See [Milestones](../../docs/milestones.md) for sequencing (Portal is built **first**).
